...
(function ($, window, document, undefined) {
  ...
  Tree.prototype.setInitialStates = function (node, level) {
    ...
    $.each(node.nodes, function checkStates(index, node) {
      if (typeof _this.options.onNodeRender === "function") {
        node = _this.options.onNodeRender(node);
      }
  ...
  Tree.prototype.render = function () {
    ...
    if (typeof this.options.onTreeRenderComplete === "function") {
      this.options.onTreeRenderComplete();
    }
  };
  ...
  Tree.prototype.buildTree = function (nodes, level) {
    ...
    $.each(nodes, function addNodes(id, node) {
      var treeItem = $(_this.template.item)
        ...
        .attr("draggable", node.state.draggable ? "true" : "false")
      ...
      if (typeof _this.options.onNodeRendered === "function") {
        node = _this.options.onNodeRendered(id, node);
      }
